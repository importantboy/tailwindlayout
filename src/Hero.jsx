  ...
  return (
    <div className='relative h-screen text-left overflow-x-hidden'>
         ...
         <h1 className='text-4xl font-semibold text-center sm:text-5xl md:text-6xl'>Blazing Fast & Secure <br></br>Cloud Hosting for Your Business</h1>
          <p className='text-md md:text-2xl mt-4 text-center'>Deploy your websites in seconds with 99.99% uptime and 24/7 support.</p>
         <button className='py-3 px-4 mt-4 text-lg  bg-emerald-800 text-emerald-50 rounded-md hover:cursor-pointer hover:bg-emerald-300 hover:text-emerald-900 transition-all duration-100 ease-in font-bold'>Start Your Free Trial</button>
          </div>
</div>
  )
}
